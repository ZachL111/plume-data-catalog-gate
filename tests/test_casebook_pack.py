"""Regression checks for the plume-data-catalog-gate casebook."""
...
from casebook.harness import assert_expected, plume_data_catalog_gate_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(plume_data_catalog_gate_summary(), assert_expected())
