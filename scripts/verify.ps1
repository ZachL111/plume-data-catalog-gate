...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-plume-data-catalog-detail.ps1
...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-plume-data-catalog-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-plume-data-catalog-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-plume_data_catalog_gate-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
